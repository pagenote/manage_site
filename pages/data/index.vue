...
export default Vue.extend({
  ...
  computed: {
    result() {
      return this.input ? (decodeTextToWebPage(this.input,this.secretKey) || '解密失败了') : '请填入加密数据'
    }
  },
})
</script>
