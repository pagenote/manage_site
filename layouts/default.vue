...
<!--      </div>-->
<!--    </v-navigation-drawer>-->
<!--    &lt;!&ndash;    <v-app-bar :clipped-left="clipped" fixed app>&ndash;&gt;-->
<!--    &lt;!&ndash;      <v-btn icon @click.stop="miniVariant = !miniVariant">&ndash;&gt;-->
<!--    &lt;!&ndash;        <v-icon>mdi-{{ `chevron-${miniVariant ? 'right' : 'left'}` }}</v-icon>&ndash;&gt;-->
<!--    &lt;!&ndash;      </v-btn>&ndash;&gt;-->
<!--    &lt;!&ndash;      <v-btn icon @click.stop="clipped = !clipped">&ndash;&gt;-->
<!--    &lt;!&ndash;        <v-icon>mdi-application</v-icon>&ndash;&gt;-->
<!--    &lt;!&ndash;      </v-btn>&ndash;&gt;-->
<!--    &lt;!&ndash;      <v-btn icon @click.stop="fixed = !fixed">&ndash;&gt;-->
<!--    &lt;!&ndash;        <v-icon>mdi-minus</v-icon>&ndash;&gt;-->
<!--    &lt;!&ndash;      </v-btn>&ndash;&gt;-->
<!--    &lt;!&ndash;      <v-toolbar-title v-text="title" />&ndash;&gt;-->
<!--    &lt;!&ndash;      <v-spacer />&ndash;&gt;-->
<!--    &lt;!&ndash;      <v-btn icon @click.stop="rightDrawer = !rightDrawer">&ndash;&gt;-->
...
<!--      <div>通知</div>-->
<!--    </v-navigation-drawer>-->
<!--    &lt;!&ndash;    <v-footer :absolute="!fixed" app>&ndash;&gt;-->
